...
Most of the source codes of this project, `scray-sample` are stored in the `scray_sample` directory.
...
`make create-container` creates and launch the scray_sample container.
